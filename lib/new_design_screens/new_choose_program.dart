...
import '../services/home_remedies_service/home_remedies_service.dart';
...
class NewChooseProgram extends StatefulWidget {
  const NewChooseProgram({Key? key}) : super(key: key);

  @override
  State<NewChooseProgram> createState() => _NewChooseProgramState();
}

class _NewChooseProgramState extends State<NewChooseProgram> {
