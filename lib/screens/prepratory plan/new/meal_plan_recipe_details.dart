...
class _MealPlanRecipeDetailsState extends State<MealPlanRecipeDetails>
  ...
  List colors = [newDashboardGreenButtonColor.withOpacity(0.3),
  ...
  buildIngredients() {
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemCount: meals?.ingredient?.length ?? 0,
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 1.h),
                  Text(meals?.ingredient?[index].ingredientName ?? '',
                  ...
                  SizedBox(height: 0.5.h),
                  Text(
                    '${meals?.ingredient?[index]?.qty} ${meals?.ingredient?[index]?.unit}' ?? '',
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 2.h),
          if(meals?.variation != null)
            ...meals!.variation!.map((e) =>
                profileTile(e.variationTitle ?? '',
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 2.h),
          if(meals!.howToStore != null)
            ...meals!.howToStore!.split('*').map((e) {
              return  profileTile(e.split(":").first,
                  e.split(":").last);
            }).toList(),
