...
class ChildMealPlanDetailsModel1 {
  String? type;
  String? mealTime;
  int? itemId;
  String? name;
  ...
  ChildMealPlanDetailsModel1.fromJson(Map<String, dynamic> json) {
    print("ChildMealPlanDetailsModel1.fromJson");
    type = json['type'] ?? '';
